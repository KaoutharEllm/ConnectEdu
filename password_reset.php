...
<body>
  <div class="container">
    ...
    <a href="http://localhost/connectEdu/reset_password_form.php?token=' . $token . '" class="button">Réinitialiser mon mot de passe</a>
...
$mail->AltBody = 'Pour réinitialiser votre mot de passe, copiez et collez l\'URL suivante dans votre navigateur : http://localhost/connectEdu/reset_password_form.php?token=' . $token;
