...
$mail->isHTML(true);
$mail->Subject = 'New Assignment: ' . $titre;
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <h2 class='highlight'>Assignment Title: {$titre}</h2>
            <p><strong>Description:</strong> {$description}</p>
            <p><strong>Due Date:</strong> <span class='due-date'>{$dateLimite}</span></p>
            <a href='http://localhost/connectEdu/logging.html' class='button'>Go to Assignments</a>
        </div>
        <div class='footer'>
...
try {
    $mail->send();
    echo 'Email has been sent to all enrolled students.';
} catch (Exception $e) {
